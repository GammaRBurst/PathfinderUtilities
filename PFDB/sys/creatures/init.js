	...
	if(url.indexOf('?') >= 0) {
		...
		for(var i = monsters.length - 1; i >= 0; i--) {
			if(monsters[i].trim() == '' || monsters[i].trim().indexOf('#') == 0) { //Removing comments and empty lines
				...
				//Name
				monsters[i][0] = monsters[i][0].trim();
				//CR
		...
		if(simple_list) {
			$('#table').append('<table id="creatures_table"><thead><tr><th id="tenc">Creatures</th><th id="tcr">CR</th><th id="tnote">Variation of</th><th id="tsource">Source</th></tr></thead><tfoot><tr><td colspan="4">' + foot_msg + '</td></tr></tfoot><tbody></tbody></table>');
		}
		else if(maxdice == 0) {
			$('#table').append('<table id="creatures_table"><thead><tr><th id="tenc">Encounter</th><th id="tcr">Avg. CR</th><th id="tnote">Variation of</th><th id="tsource">Source</th></tr></thead><tfoot><tr><td colspan="4">' + foot_msg + '</td></tr></tfoot><tbody></tbody></table>');
		}
		else {
			$('#table').append('<table id="creatures_table"><thead><tr><th id="tdice">dice</th><th id="tenc">Encounter</th><th id="tcr">Avg. CR</th><th id="tnote">Variation of</th><th id="tsource">Source</th></tr></thead><tfoot><tr><td colspan="5">' + foot_msg + '</td></tr></tfoot><tbody></tbody></table>');
		}
		...
		for(var i = 0; i < monsters.length; i++) {
			...
			if(maxdice == 0 || simple_list) {
				$('#creatures_table tbody').append('<tr><td>' + monsters[i][0] + '</td><td>' + temp_cr + '</td><td>' + monsters[i][3] + '</td><td>' + temp_source + '</td></tr>');
			}
			else {
				$('#creatures_table tbody').append('<tr><td>' + interval + '</td><td>' + monsters[i][0] + '</td><td>' + temp_cr + '</td><td>' + monsters[i][3] + '</td><td>' + temp_source + '</td></tr>');
			}
		}
	}
});
